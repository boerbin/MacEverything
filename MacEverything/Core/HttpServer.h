...
public:
    ...
    using ModelManagerGetter = std::function<std::shared_ptr<ModelManager>()>;
    ...
    void setAIGetters(NLTranslatorGetter ntg, ModelManagerGetter mmg);
...
private:
    ...
    ModelManagerGetter getModelManager_;
